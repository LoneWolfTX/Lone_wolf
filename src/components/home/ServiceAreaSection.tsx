        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '40px', alignItems: 'center' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.96rem', color: '#475569', lineHeight: '1.6', marginBottom: '20px' }}>
              Wolf Ridge Dumpsters provides prompt roll-off container delivery across <strong>Dallas, Tarrant, and Denton Counties</strong> with guaranteed driveway protection and flexible rental periods.
            </p>

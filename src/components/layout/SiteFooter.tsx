  ...
  return (
    <footer style={{ backgroundColor: '#000000', color: '#ffffff', borderTop: '1px solid #1e293b' }}>
      <div className="container" style={{ paddingTop: '40px', paddingBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: '4px' }}>
              <a
                ...
                aria-label="Wolf Ridge Facebook Page"
              >
              ...
              <a
                href="https://www.instagram.com/wolfridgedumpsters"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  width: '32px',
                ...
                aria-label="Wolf Ridge Instagram Profile"
              >
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div>
            &copy; 2026 Wolf Ridge Dumpsters
          </div>

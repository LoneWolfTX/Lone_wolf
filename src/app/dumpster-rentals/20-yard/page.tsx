...
export const metadata: Metadata = {
  ...
  description: 'Rent our versatile 20-yard roll-off dumpster in DFW. Dimensions: 16ft L x 7.5ft W x 4.5ft H with 2.0 tons (4,000 lbs) included. Perfect for roofing, remodels, and whole-house cleanouts.',
  alternates: {

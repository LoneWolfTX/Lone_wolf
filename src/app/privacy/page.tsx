...
export const metadata: Metadata = {
  title: 'Privacy Policy | Wolf Ridge Dumpsters LLC',
  description: 'Privacy Policy for Wolf Ridge Dumpsters LLC. Learn how we collect, use, and protect your information when booking dumpster rentals and requesting quotes.',
  alternates: {
    canonical: 'https://wolfridgedumpsters.com/privacy',
  },
  openGraph: {
    title: 'Privacy Policy | Wolf Ridge Dumpsters LLC',
    description: 'Privacy Policy for Wolf Ridge Dumpsters LLC. Learn how we collect, use, and protect your information.',
    url: 'https://wolfridgedumpsters.com/privacy',
  },
};
  ...
  return (
    <>
      <PageHero
        ...
        headlineRed="POLICY"
        description="Learn how Wolf Ridge Dumpsters LLC collects, protects, and manages customer information across Dallas–Fort Worth."
      ...
      <section style={{ backgroundColor: '#ffffff', color: '#1e293b', padding: '60px 0', minHeight: '50vh' }}>
        <div className="container" style={{ maxWidth: '860px', lineHeight: 1.7, fontSize: '1rem' }}>
          ...
          <p style={{ marginBottom: '20px', color: '#334155' }}>
            By submitting your phone number via our quote request form, you consent to receive direct phone calls and text messages (SMS) from Wolf Ridge Dumpsters regarding your quote, delivery scheduling, and service updates. Message and data rates may apply. You may opt out of SMS messages at any time by replying STOP.
          </p>
          ...
          <div style={{ backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '20px', marginBottom: '32px' }}>
            <p style={{ margin: '0 0 6px 0', fontWeight: 700, color: '#0f172a' }}>Wolf Ridge Dumpsters LLC</p>
